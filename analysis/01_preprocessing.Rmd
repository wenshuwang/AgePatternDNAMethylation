...
# Keep CpGs present in at least 18 of 23 datasets (~75%), matching the manuscript cutoff.

filtered_sites <- running_site_list[running_site_list$Count >= 18, , drop=FALSE]
