...
# manuscript builds its age-summary matrices from the 393,628 CpGs present in
# at least 18 of 23 datasets. The 256,529-site sample-coverage list is retained
# as a separate diagnostic checkpoint.
...
saveRDS(dataset_presence_sites, "intermediates/POST_sites.rds")
...
```{r}
# The paper's matrices contain the 393,628 CpGs passing the 18-of-23-dataset
# presence cutoff.

#cpg_list <- readRDS("cpg_list.rds")
input_folder <- "data/splits/"
cpg_list <- readRDS("intermediates/POST_sites_18of23_datasets.rds")
full_metadata <- readRDS("intermediates/full_metadata.rds")
valid_samples <- readRDS("intermediates/valid_samples.rds")
