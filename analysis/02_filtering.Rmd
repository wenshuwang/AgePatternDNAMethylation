...
all_results <- extractResults("data/matrix/allTRUE.csv", "data/matrix/allFALSE.csv", 0.2)
male_results <- extractResultsParallel("data/matrix/maleTRUE.csv", "data/matrix/maleFALSE.csv", 0.2)
female_results <- extractResultsParallel("data/matrix/femaleTRUE.csv", "data/matrix/femaleFALSE.csv", 0.2)
...
all_sig_counts    <- extract_sites(all_results,    filtered_list, "All",    0.5, 0.2, 0.2, 2, TRUE)
male_sig_counts   <- extract_sites(male_results,   filtered_list, "Male",   0.5, 0.2, 0.2, 2, TRUE)
female_sig_counts <- extract_sites(female_results, filtered_list, "Female", 0.5, 0.2, 0.2, 2, TRUE)
