...
This directory contains exploratory, superseded, and one-off analysis material
retained for provenance. These files are not required by the current pipeline
documented in the repository's main README.
...
archive. Avoid using these files as pipeline entry points unless reproducing an
older analysis.
