...
When this complete set is present, `analysis/02_filtering.Rmd` automatically
uses it and validates the original checkpoints before analysis. The expected
counts are 393,628 CpGs present in at least 18 of 23 datasets, 256,529 CpGs in
the downstream sample-coverage list, and 4,641 valid samples.
